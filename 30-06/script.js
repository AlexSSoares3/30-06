...
compras.push("café")  //adciona "café" no FIM
compras[0] = "arroz integral" //TROCA o item de posição 0
...
let tarefas = [];
   ...
   let contador = document.getElementById("constador")
...
formulario.addEventListener("submit", function(evento){
   evento.preventDefault(); //impede a página de recarrega
